...
ALTER TABLE [dbo].[Order]  WITH CHECK ADD  CONSTRAINT [FKOrderUser] FOREIGN KEY([UserId])
REFERENCES [dbo].[AspNetUsers] ([Id])
GO

ALTER TABLE [dbo].[Order] CHECK CONSTRAINT [FKOrderUser]
GO

ALTER TABLE [dbo].[Stock]  WITH CHECK ADD  CONSTRAINT [FKStock] FOREIGN KEY([ProductId])
